...
7. Provide the following information:
    ...
    - <b>Depricated:</b> PIC-SURE is now using a unified frontend with feture flags. See README. 
    ...
    - `MIGRATION_NAME`: This is the name of the migration that will be run. If you just want the default PIC-SURE behavior use `Baseline` from the repo: https://github.com/hms-dbmi/pic-sure-migrations or fork it and add your migration. 
