...
- Create Home Dir for Stack /usr/local/docker-config
...
13. Jenkins service is managed by, Jenkins is running on port 8080
-  **To start Jenkins service**
    - systemctl start jenkins OR sudo systemctl start jenkins
- **To stop Jenkins service**
    - systemctl stop jenkins OR sudo systemctl stop jenkins
