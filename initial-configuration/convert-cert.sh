...
sed -i "2 i JENKINS_OPTS_STR=\"--httpPort=-1 --httpsPort=8080 --httpsKeyStore=/var/jenkins_cert/certificate.pfx --httpsKeyStorePassword=$jenkinspass\"" ../start-jenkins.sh
